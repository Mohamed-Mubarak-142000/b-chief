const BroadCardImage = ({ title }: { title: string }) => {
  return (
    <section className="broadImage select-none shadow-2xl">
      ...
      <div className="text-center text-xl lg:text-3xl font-bold text-white lg:bg-transparent bg-black bg-opacity-40 shadow-lg  w-fit mx-auto px-8 flex flex-col gap-5 font-serif   ">
        ...
        <h3 className="xl:text-4xl "> {title}</h3>
      </div>
    </section>
  );
};

export default BroadCardImage;
